...
document.getElementById("submit").onclick = function(){
    ...
    const c = document.getElementById("a3")
    ...
    const e = document.getElementById("a5")
    ...
    const f = document.getElementById("a6")
    ...
    const g = document.getElementById("a7")
    ...
    const h = document.getElementById("a8")
    ...
    const i = document.getElementById("a9")
    ...
    const j = document.getElementById("a10")
    ...
    let mark = aa + bb + cc + dd + ee + ff + gg + hh + ii + jj
    let total = 10
    let percent = mark / total * 100
    if(mark >= 5){
        document.getElementById("results").innerHTML = "You have obtained " + percent + "%, you have passed! "
    }
    else{
        document.getElementById("results").innerHTML = "You have obtained " + percent + "%, you have failed! "
    }
